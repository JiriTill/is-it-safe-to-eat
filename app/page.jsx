  ...
  return (
    <div className="space-y-8">
      <section className="text-center">
        ...
        <p className="text-slate-300 mb-5">Type what you have and where it’s been. We’ll tell you how long it stays safe — in plain English.</p>
        <SearchBar />
        <p className="text-slate-400 text-xs mt-3">Examples: <span className="italic">fried chicken in fridge for 3 days</span>, <span className="italic">pizza left out overnight</span>, <span className="italic">sushi 1 day fridge</span></p>
      </section>
